...
const translations = {
    'zh-CN': {
        ...
        'games.filter.favorites': '我的收藏',
        'favorites.add': '收藏',
        'favorites.remove': '取消收藏',
        'favorites.added': '已收藏',
        'favorites.toggleFailed': '收藏操作失败，请重试',
        'favorites.empty': '还没有收藏任何游戏，点游戏卡片右上角的心形按钮即可收藏',
        ...
        'analytics.totalViews': '今日访问量',
        'analytics.totalPlays': '今日播放量',
        'analytics.totalDownloads': '今日下载量',
        'analytics.todayActive': '今日活跃',
        'analytics.compared': '较昨日',
        'analytics.totalLabel': '累计',
    ...
    'en': {
        ...
        'games.filter.favorites': 'My Favorites',
        'favorites.add': 'Favorite',
        'favorites.remove': 'Remove favorite',
        'favorites.added': 'Favorited',
        'favorites.toggleFailed': 'Favorite action failed, please retry',
        'favorites.empty': 'No favorites yet. Tap the heart button on a game card to favorite it',
        ...
        'analytics.totalViews': 'Today Views',
        'analytics.totalPlays': 'Today Plays',
        'analytics.totalDownloads': 'Today Downloads',
