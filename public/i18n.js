...
const translations = {
    'zh-CN': {
        ...
        'order.managerHint': '输入目标位置序号；保存后所有游戏会自动重新编号为 1～N，留空表示保持当前位置。',
        'order.toTop': '置顶',
    ...
    'en': {
        ...
        'order.managerHint': 'Enter target positions; after saving, all games are renumbered 1 to N. Leave empty to keep current position.',
        'order.toTop': 'To Top',
