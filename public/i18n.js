...
const translations = {
    'zh-CN': {
        ...
        'history.title': '最近游玩',
        'history.clear': '清空',
        'history.clearConfirm': '确定要清空最近游玩记录吗？',
        'rating.title': '评分',
        'rating.stars': '星',
        'rating.noRating': '暂无评分',
        'rating.needPlay': '玩过该游戏后才能评分',
        'rating.submitSuccess': '评分成功！',
        'rating.submitFailed': '评分失败',
        'rating.distributionToggle': '评分分布',
        ...
        'tag.type.general': '一般',
        'tag.type.author': '作者',
        'tag.type.character': '角色',
        'tag.type.body': '身体特征',
        'tag.type.action': '动作/姿势',
        'tag.type.warning': '内容警告',
        'tag.filter.allTypes': '全部标签类型',
        'tag.manager.title': '标签管理',
        'tag.manager.hint': '修改类型或描述后点保存；修改立即对全站生效。',
        'tag.manager.save': '保存',
        'tag.manager.saveSuccess': '标签已更新',
        'tag.manager.saveFailed': '标签更新失败',
        'tag.manager.type': '类型',
        'tag.manager.description': '描述',
        'tag.manager.descriptionPlaceholder': '标签说明（可选）',
        'order.managerTitle': '游戏排序',
        'order.managerHint': '编辑序号后按回车自动重排，其他游戏会围绕该位置重新编号；最后点保存才真正生效。',
        'order.toTop': '置顶',
        'order.loadFailed': '加载排序列表失败',
        'order.saveSuccess': '排序保存成功！',
        'order.saveFailed': '排序保存失败',
        'wish.banner': '没有找到想玩的游戏？',
        'wish.button': '提交愿望',
        'wish.title': '提交游戏愿望',
        'wish.titlePlaceholder': '游戏标题（必填）',
        'wish.linkPlaceholder': '链接（可选，需以 http:// 或 https:// 开头）',
        'wish.notePlaceholder': '说明（可选，比如作品名、作者、类型等）',
        'wish.submit': '提交',
        'wish.titleRequired': '请填写游戏标题',
        'wish.submitSuccess': '愿望提交成功！',
        'wish.submitFailed': '提交失败',
        'wish.managerTitle': '游戏愿望单',
        'wish.empty': '暂时没有愿望',
        'wish.statusPending': '待处理',
        'wish.statusDone': '已完成',
        'wish.markDone': '标记完成',
        'wish.markPending': '标记待处理',
        'wish.deleteConfirm': '确定要删除这条愿望吗？',
        'wish.loadFailed': '加载愿望单失败',
        'wish.view': '查看愿望单',
        'wish.publicTitle': '大家的愿望',
        'wish.voteFailed': '点赞失败，请重试',
        'wish.adminNoteLabel': '管理员备注',
        'wish.adminNotePlaceholder': '管理员备注（公开显示）',
        'wish.saveNote': '保存备注',
        'wish.saveNoteSuccess': '备注已保存',
        'wish.saveNoteFailed': '备注保存失败',
        'wish.statusRejected': '已拒绝',
        'wish.setPending': '恢复待处理',
        'wish.setDone': '标记完成',
        'wish.setRejected': '拒绝',
        'wish.statusUpdateFailed': '状态更新失败',
    ...
    'en': {
        ...
        'games.filter.allRatings': 'All Ratings',
        ...
        'history.clear': 'Clear',
        'history.clearConfirm': 'Clear recently played history?',
        'rating.title': 'Rating',
        'rating.stars': 'stars',
        'rating.noRating': 'No rating yet',
        'rating.needPlay': 'Play this game before rating',
        'rating.submitSuccess': 'Rating submitted!',
        'rating.submitFailed': 'Rating failed',
        'rating.distributionToggle': 'Rating distribution',
        ...
        'tag.type.author': 'Author',
        'tag.type.character': 'Character',
        'tag.type.body': 'Body Feature',
        'tag.type.action': 'Action/Pose',
        'tag.type.warning': 'Warning',
        'tag.filter.allTypes': 'All Tag Types',
        'tag.manager.title': 'Tag Manager',
        'tag.manager.hint': 'Change type or description and press save; changes apply site-wide.',
        'tag.manager.save': 'Save',
        'tag.manager.saveSuccess': 'Tag updated',
        'tag.manager.saveFailed': 'Tag update failed',
        ...
        'order.managerHint': 'Edit a number and press Enter to reorder instantly; other games are renumbered around it. Save to apply.',
        'order.toTop': 'To Top',
        'order.loadFailed': 'Failed to load order list',
        'order.saveSuccess': 'Order saved!',
        'order.saveFailed': 'Failed to save order',
        'wish.banner': 'Looking for a game that is not here?',
        'wish.button': 'Submit Request',
        'wish.title': 'Request a Game',
        'wish.titlePlaceholder': 'Game title (required)',
        'wish.linkPlaceholder': 'Link (optional, must start with http:// or https://)',
        'wish.notePlaceholder': 'Notes (optional, e.g. series, author, genre)',
        'wish.submit': 'Submit',
        'wish.titleRequired': 'Please enter a game title',
        'wish.submitSuccess': 'Request submitted!',
        'wish.submitFailed': 'Submission failed',
        'wish.managerTitle': 'Game Requests',
        'wish.empty': 'No requests yet',
        'wish.statusPending': 'Pending',
        'wish.statusDone': 'Done',
        'wish.markDone': 'Mark done',
        'wish.markPending': 'Mark pending',
        'wish.deleteConfirm': 'Delete this request?',
        'wish.loadFailed': 'Failed to load requests',
        'wish.view': 'View Requests',
        'wish.publicTitle': 'Game Requests',
        'wish.voteFailed': 'Vote failed, please retry',
        'wish.adminNoteLabel': 'Admin note',
        'wish.adminNotePlaceholder': 'Admin note (publicly visible)',
        'wish.saveNote': 'Save note',
        'wish.saveNoteSuccess': 'Note saved',
        'wish.saveNoteFailed': 'Failed to save note',
        'wish.statusRejected': 'Rejected',
        'wish.setPending': 'Set pending',
        'wish.setDone': 'Mark done',
        'wish.setRejected': 'Reject',
        'wish.statusUpdateFailed': 'Failed to update status',
